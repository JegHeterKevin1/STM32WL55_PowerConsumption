...
* Description        : H3LIS331DL Platform Independent Driver
*
********************************************************************************
...
{
  if (!H3LIS331DL_ACC_ReadReg(handle, H3LIS331DL_WHO_AM_I_REG, val, 1))
  {
    return MEMS_ERROR;
  }
...
* Input          : H3LIS331DL_ENABLE/H3LIS331DL_DISABLE
* Output         : None
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_SetBDU(void *handle, H3LIS331DL_ACC_State_t bdu)
{
  u8_t value;
...
/*******************************************************************************
* Function Name  : H3LIS331DL_GetFullScale
* Description    : Gets the H3LIS331DL FullScale
* Input          : None
* Output         : H3LIS331DL_FULLSCALE_2/H3LIS331DL_FULLSCALE_4/H3LIS331DL_FULLSCALE_8
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_GetFullScale(void *handle, H3LIS331DL_Fullscale_t *fs)
{
  u8_t value;
  ...
  value &= H3LIS331DL_FS_MASK;
  value >>= H3LIS331DL_FS;

  *fs = (H3LIS331DL_Fullscale_t)value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_GetAccAxesRaw(void *handle, H3LIS331DL_ACC_AxesRaw_t *buff)
{
  i16_t value;
...
/*******************************************************************************
* Function Name  : H3LIS331DL_GetODR
* Description    : Gets H3LIS331DL Accelerometer Output Data Rate
* Input          : None
* Output         : Output Data Rate
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_GetODR(void *handle, H3LIS331DL_ODR_t *dr)
{
  u8_t value;
  ...
  value &= H3LIS331DL_DR_MASK;
  value >>= H3LIS331DL_DR;

  *dr = (H3LIS331DL_ODR_t)value;
...
/*******************************************************************************
* Function Name  : H3LIS331DL_GetMode
* Description    : Gets H3LIS331DL Accelerometer Operating Mode
* Input          : None
* Output         : Modality (H3LIS331DL_LOW_POWER, H3LIS331DL_NORMAL, H3LIS331DL_POWER_DOWN...)
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_GetMode(void *handle, H3LIS331DL_Mode_t *pm)
{
  u8_t value;
  ...
  value &= H3LIS331DL_PM_MASK;
  value >>= H3LIS331DL_PM;

  *pm = (H3LIS331DL_Mode_t)value;
...
/*******************************************************************************
* Function Name  : H3LIS331DL_GetAxis
* Description    : Get H3LIS331DL Axis Enable/Disable status
* Input          : None
* Output         : H3LIS331DL_X_ENABLE/H3LIS331DL_X_DISABLE | H3LIS331DL_Y_ENABLE/H3LIS331DL_Y_DISABLE
                   | H3LIS331DL_Z_ENABLE/H3LIS331DL_Z_DISABLE
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_GetAxis(void *handle, H3LIS331DL_Axis_t *axis)
{
  u8_t value;
  ...
  value &= H3LIS331DL_AXIS_MASK;
  value >>= H3LIS331DL_XEN;

  *axis = (H3LIS331DL_Axis_t)value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_SetFDS(void *handle, H3LIS331DL_ACC_State_t fds)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_SetBOOT(void *handle, H3LIS331DL_ACC_State_t boot)
{
  u8_t value;
...
* Input          : H3LIS331DL_DISABLE/H3LIS331DL_ENABLE
* Output         : None
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_SetSelfTest(void *handle, H3LIS331DL_ACC_State_t st)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_SetSelfTestSign(void *handle, H3LIS331DL_ACC_State_t st_sign)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_SetIntHighLow(void *handle, H3LIS331DL_ACC_State_t ihl)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_SetIntPPOD(void *handle, H3LIS331DL_ACC_State_t pp_od)
{
  u8_t value;
...
* Input          : H3LIS331DL_ENABLE/H3LIS331DL_DISABLE
* example        : H3LIS331DL_SetInt2HPEnable(H3LIS331DL_ENABLE)
* Output         : None
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_SetInt2HPEnable(void *handle, H3LIS331DL_ACC_State_t stat)
{
  u8_t value;
...
* Input          : H3LIS331DL_ENABLE/H3LIS331DL_DISABLE
* example        : H3LIS331DL_SetInt1HPEnable(H3LIS331DL_ENABLE)
* Output         : None
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_SetInt1HPEnable(void *handle, H3LIS331DL_ACC_State_t stat)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_Int1LatchEnable(void *handle, H3LIS331DL_ACC_State_t latch)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t H3LIS331DL_Int2LatchEnable(void *handle, H3LIS331DL_ACC_State_t latch)
{
  u8_t value;
