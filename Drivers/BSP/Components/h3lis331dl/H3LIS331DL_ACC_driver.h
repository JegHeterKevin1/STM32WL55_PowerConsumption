...
* Description        : H3LIS331DL Platform Independent Driver - header file
*
********************************************************************************
...
typedef struct
{
  ...
  i16_t AXIS_Y;
  i16_t AXIS_Z;
} H3LIS331DL_ACC_AxesRaw_t;

typedef enum
{
  H3LIS331DL_ENABLE                 =   0x01,
  H3LIS331DL_DISABLE                =   0x00
} H3LIS331DL_ACC_State_t;
...
#define H3LIS331DL_I2C_ADDRESS_LOW                        0x30
#define H3LIS331DL_I2C_ADDRESS_HIGH                       0x32

//Register and define
#define H3LIS331DL_WHO_AM_I_REG       0x0F  // device identification register
#define H3LIS331DL_WHO_AM_I           0x32  // device identification value
...
//Output Data Rate bit mask
#define H3LIS331DL_DR_MASK                                0x18

//Power Mode bit mask
#define H3LIS331DL_PM_MASK                                0xE0

//Axis enable/disable bit mask
#define H3LIS331DL_AXIS_MASK                              0x07

//Full Scale bit mask
#define H3LIS331DL_FS_MASK                                0x30
...
status_t H3LIS331DL_SetFilterDataSel(void *handle, H3LIS331DL_ACC_State_t state);
status_t H3LIS331DL_SetReference(void *handle, i8_t ref);
status_t H3LIS331DL_HPFilterReset(void *handle);

//Interrupt Functions
status_t H3LIS331DL_SetIntHighLow(void *handle, H3LIS331DL_ACC_State_t hil);
