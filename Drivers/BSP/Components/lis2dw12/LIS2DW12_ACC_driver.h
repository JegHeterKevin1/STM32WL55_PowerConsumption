...
#define   LIS2DW12_ACC_INT1_MODE_MASK   0xFFu
...
#define   LIS2DW12_ACC_INT2_MODE_MASK   0xFFu
...
typedef enum
{
  LIS2DW12_ACC_DRDY_NOT_READY      = 0x00,
  LIS2DW12_ACC_DRDY_NEW_AVAILABLE      = 0x01,
} LIS2DW12_ACC_DRDY_t;

#define   LIS2DW12_ACC_DRDY_MASK    0x01
...
typedef enum
{
  LIS2DW12_ACC_FF_IA_NOT_DETECTED      = 0x00,
  LIS2DW12_ACC_FF_IA_DETECTED      = 0x02,
} LIS2DW12_ACC_FF_IA_t;

#define   LIS2DW12_ACC_FF_IA_MASK   0x02
...
typedef enum
{
  LIS2DW12_ACC_6D_IA_NOT_DETECTED      = 0x00,
  LIS2DW12_ACC_6D_IA_DETECTED      = 0x04,
} LIS2DW12_ACC_6D_IA_t;

#define   LIS2DW12_ACC_6D_IA_MASK   0x04
...
typedef enum
{
  LIS2DW12_ACC_SINGLE_TAP_NOT_DETECTED     = 0x00,
  LIS2DW12_ACC_SINGLE_TAP_DETECTED     = 0x08,
} LIS2DW12_ACC_SINGLE_TAP_t;

#define   LIS2DW12_ACC_SINGLE_TAP_MASK    0x08
...
typedef enum
{
  LIS2DW12_ACC_DOUBLE_TAP_NOT_DETECTED     = 0x00,
  LIS2DW12_ACC_DOUBLE_TAP_DETECTED     = 0x10,
} LIS2DW12_ACC_DOUBLE_TAP_t;

#define   LIS2DW12_ACC_DOUBLE_TAP_MASK    0x10
...
typedef enum
{
  LIS2DW12_ACC_SLEEP_STATE_NOT_DETECTED      = 0x00,
  LIS2DW12_ACC_SLEEP_STATE_DETECTED      = 0x20,
} LIS2DW12_ACC_SLEEP_STATE_t;

#define   LIS2DW12_ACC_SLEEP_STATE_MASK   0x20
...
typedef enum
{
  LIS2DW12_ACC_WU_IA_NOT_DETECTED      = 0x00,
  LIS2DW12_ACC_WU_IA_DETECTED      = 0x40,
} LIS2DW12_ACC_WU_IA_t;

#define   LIS2DW12_ACC_WU_IA_MASK   0x40
...
typedef enum
{
  LIS2DW12_ACC_FIFO_THS_BELOW_LEVEL      = 0x00,
  LIS2DW12_ACC_FIFO_THS_LEVEL_REACHED      = 0x80,
} LIS2DW12_ACC_FIFO_THS_t;

#define   LIS2DW12_ACC_FIFO_THS_MASK    0x80
...
* Permission    : RW
*******************************************************************************/
#define   LIS2DW12_ACC_ABS_INT_X_MASK   0xFFu
...
* Permission    : RW
*******************************************************************************/
#define   LIS2DW12_ACC_ABS_INT_Y_MASK   0xFFu
...
typedef enum
{
  LIS2DW12_ACC_SLEEP_STATE_IA_NOT_OCCURRED     = 0x00,
  LIS2DW12_ACC_SLEEP_STATE_IA_OCCURRED     = 0x20,
} LIS2DW12_ACC_SLEEP_STATE_IA_t;

#define   LIS2DW12_ACC_SLEEP_STATE_IA_MASK    0x20
status_t LIS2DW12_ACC_R_SleepState_event(void *handle, LIS2DW12_ACC_SLEEP_STATE_IA_t *value);

/*******************************************************************************
* Register      : STATUS_DUP
* Address       : 0X37
* Bit Group Name: DRDY_T
* Permission    : RO
*******************************************************************************/
typedef enum
{
  LIS2DW12_ACC_DRDY_T_NOT_AVAILABLE      = 0x00,
  LIS2DW12_ACC_DRDY_T_AVAILABLE      = 0x40,
} LIS2DW12_ACC_DRDY_T_t;

#define   LIS2DW12_ACC_DRDY_T_MASK    0x40
...
typedef enum
{
  LIS2DW12_ACC_OVR_NOT_OCCURRED      = 0x00,
  LIS2DW12_ACC_OVR_OCCURRED      = 0x80,
} LIS2DW12_ACC_OVR_t;

#define   LIS2DW12_ACC_OVR_MASK   0x80
