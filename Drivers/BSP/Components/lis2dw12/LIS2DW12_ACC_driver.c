...
/*******************************************************************************
  * Function Name  : LIS2DW12_ACC_R_DataStatus
  * Description    : Read DRDY
  * Input          : Pointer to LIS2DW12_ACC_DRDY_t
  * Output         : Status of DRDY see LIS2DW12_ACC_DRDY_t
  * Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DW12_ACC_R_DataStatus(void *handle, LIS2DW12_ACC_DRDY_t *value)
{
  ...
  *value &= LIS2DW12_ACC_DRDY_MASK; //mask

  return MEMS_SUCCESS;
}

/*******************************************************************************
  * Function Name  : LIS2DW12_ACC_R_FreeFall_Event
  * Description    : Read FF_IA
  * Input          : Pointer to LIS2DW12_ACC_FF_IA_t
  * Output         : Status of FF_IA see LIS2DW12_ACC_FF_IA_t
  * Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DW12_ACC_R_FreeFall_Event(void *handle, LIS2DW12_ACC_FF_IA_t *value)
{
  if (!LIS2DW12_ACC_ReadReg(handle, LIS2DW12_ACC_STATUS, (u8_t *)value, 1))
  {
    return MEMS_ERROR;
  ...
  *value &= LIS2DW12_ACC_FF_IA_MASK; //mask

  return MEMS_SUCCESS;
}

/*******************************************************************************
  * Function Name  : LIS2DW12_ACC_R_6D_Event
  * Description    : Read 6D_IA
  * Input          : Pointer to LIS2DW12_ACC_6D_IA_t
  * Output         : Status of 6D_IA see LIS2DW12_ACC_6D_IA_t
  * Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DW12_ACC_R_6D_Event(void *handle, LIS2DW12_ACC_6D_IA_t *value)
{
  if (!LIS2DW12_ACC_ReadReg(handle, LIS2DW12_ACC_STATUS, (u8_t *)value, 1))
  {
    return MEMS_ERROR;
  ...
  *value &= LIS2DW12_ACC_6D_IA_MASK; //mask

  return MEMS_SUCCESS;
}

/*******************************************************************************
  * Function Name  : LIS2DW12_ACC_R_SingleTap_Event
  * Description    : Read SINGLE_TAP
  * Input          : Pointer to LIS2DW12_ACC_SINGLE_TAP_t
  * Output         : Status of SINGLE_TAP see LIS2DW12_ACC_SINGLE_TAP_t
  * Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DW12_ACC_R_SingleTap_Event(void *handle, LIS2DW12_ACC_SINGLE_TAP_t *value)
{
  if (!LIS2DW12_ACC_ReadReg(handle, LIS2DW12_ACC_STATUS, (u8_t *)value, 1))
  {
    return MEMS_ERROR;
  ...
  *value &= LIS2DW12_ACC_SINGLE_TAP_MASK; //mask

  return MEMS_SUCCESS;
}

/*******************************************************************************
  * Function Name  : LIS2DW12_ACC_R_DoubleTap_Event
  * Description    : Read DOUBLE_TAP
  * Input          : Pointer to LIS2DW12_ACC_DOUBLE_TAP_t
  * Output         : Status of DOUBLE_TAP see LIS2DW12_ACC_DOUBLE_TAP_t
  * Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DW12_ACC_R_DoubleTap_Event(void *handle, LIS2DW12_ACC_DOUBLE_TAP_t *value)
{
  if (!LIS2DW12_ACC_ReadReg(handle, LIS2DW12_ACC_STATUS, (u8_t *)value, 1))
  {
    return MEMS_ERROR;
  ...
  *value &= LIS2DW12_ACC_DOUBLE_TAP_MASK; //mask

  return MEMS_SUCCESS;
}

/*******************************************************************************
  * Function Name  : LIS2DW12_ACC_R_Sleep_Event
  * Description    : Read SLEEP_STATE
  * Input          : Pointer to LIS2DW12_ACC_SLEEP_STATE_t
  * Output         : Status of SLEEP_STATE see LIS2DW12_ACC_SLEEP_STATE_t
  * Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DW12_ACC_R_Sleep_Event(void *handle, LIS2DW12_ACC_SLEEP_STATE_t *value)
{
  if (!LIS2DW12_ACC_ReadReg(handle, LIS2DW12_ACC_STATUS, (u8_t *)value, 1))
  {
    return MEMS_ERROR;
  ...
  *value &= LIS2DW12_ACC_SLEEP_STATE_MASK; //mask

  return MEMS_SUCCESS;
}

/*******************************************************************************
  * Function Name  : LIS2DW12_ACC_R_WakeUp_Event
  * Description    : Read WU_IA
  * Input          : Pointer to LIS2DW12_ACC_WU_IA_t
  * Output         : Status of WU_IA see LIS2DW12_ACC_WU_IA_t
  * Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DW12_ACC_R_WakeUp_Event(void *handle, LIS2DW12_ACC_WU_IA_t *value)
{
  if (!LIS2DW12_ACC_ReadReg(handle, LIS2DW12_ACC_STATUS, (u8_t *)value, 1))
  {
    return MEMS_ERROR;
  ...
  *value &= LIS2DW12_ACC_WU_IA_MASK; //mask

  return MEMS_SUCCESS;
}

/*******************************************************************************
  * Function Name  : LIS2DW12_ACC_R_FIFO_ThresholdStatus
  * Description    : Read FIFO_THS
  * Input          : Pointer to LIS2DW12_ACC_FIFO_THS_t
  * Output         : Status of FIFO_THS see LIS2DW12_ACC_FIFO_THS_t
  * Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DW12_ACC_R_FIFO_ThresholdStatus(void *handle, LIS2DW12_ACC_FIFO_THS_t *value)
{
  if (!LIS2DW12_ACC_ReadReg(handle, LIS2DW12_ACC_STATUS, (u8_t *)value, 1))
  {
    return MEMS_ERROR;
  ...
  *value &= LIS2DW12_ACC_FIFO_THS_MASK; //mask
...
/*******************************************************************************
  * Function Name  : LIS2DW12_ACC_R_TemperatureData
  * Description    : Read DRDY_T
  * Input          : Pointer to LIS2DW12_ACC_DRDY_T_t
  * Output         : Status of DRDY_T see LIS2DW12_ACC_DRDY_T_t
  * Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DW12_ACC_R_TemperatureData(void *handle, LIS2DW12_ACC_DRDY_T_t *value)
{
  if (!LIS2DW12_ACC_ReadReg(handle, LIS2DW12_ACC_STATUS_DUP, (u8_t *)value, 1))
  {
    return MEMS_ERROR;
  }

  *value &= LIS2DW12_ACC_DRDY_T_MASK; //mask
...
/*******************************************************************************
  * Function Name  : LIS2DW12_ACC_R_SleepState_event
  * Description    : Read SLEEP_STATE_IA
  * Input          : Pointer to LIS2DW12_ACC_SLEEP_STATE_IA_t
  * Output         : Status of SLEEP_STATE_IA see LIS2DW12_ACC_SLEEP_STATE_IA_t
  * Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DW12_ACC_R_SleepState_event(void *handle, LIS2DW12_ACC_SLEEP_STATE_IA_t *value)
{
  if (!LIS2DW12_ACC_ReadReg(handle, LIS2DW12_ACC_STATUS_DUP, (u8_t *)value, 1))
  {
    return MEMS_ERROR;
  ...
  *value &= LIS2DW12_ACC_SLEEP_STATE_IA_MASK; //mask

  return MEMS_SUCCESS;
}

/*******************************************************************************
  * Function Name  : LIS2DW12_ACC_R_OverrunEvent
  * Description    : Read OVR
  * Input          : Pointer to LIS2DW12_ACC_OVR_t
  * Output         : Status of OVR see LIS2DW12_ACC_OVR_t
  * Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DW12_ACC_R_OverrunEvent(void *handle, LIS2DW12_ACC_OVR_t *value)
{
  if (!LIS2DW12_ACC_ReadReg(handle, LIS2DW12_ACC_STATUS_DUP, (u8_t *)value, 1))
  {
    return MEMS_ERROR;
  ...
  *value &= LIS2DW12_ACC_OVR_MASK; //mask
